...
constraint item_sender_request_item_fk foreign key (item_sender) references users(id),
constraint item_receiver_request_item_fk foreign key (item_receiver) references users(id)
);
